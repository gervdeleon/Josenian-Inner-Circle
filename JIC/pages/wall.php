			...
			<div class="col-md-12">
				...
				<div class="sidebar">
                    ...
                    <a href="profile.php" class="list-group-item">
                        ...
                        <a href="wall.php" class="active list-group-item">
        ...
        <div class="col-md-8">
        	<table class="table table-striped">
        		<tr>
        			...
        			<tr>
        				<td><h3>THOUGHTS?</h3>
        					<form action="../softeng/pages/postWall.php" method="post">
        						<textarea name="userThoughts" required style="max-width:100%; max-height: 150px; margin-bottom: 10px;"></textarea>
        						<input type="submit" class="btn btn-info" value="Post" name="userThoughtsBtn">
        					</form>
        			...
        			include_once "../softeng/pages/displayPosts.php";
