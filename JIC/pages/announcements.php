    ...
    <div class="container row">
            ...
            <div class="col-md-12">
                ...
                <div class="sidebar">
                    ...
                    <div class="list-group">
                        ...
                        <a href="events.php?dept=<?php echo $_GET['dept']?>" class="list-group-item">
                            <i class="fa fa-pencil"></i> CREATE EVENTS
                        </a>
                        <a href="announcements.php?dept=<?php echo $_GET['dept']?>" class="list-group-item active">
      ...
      <!--       <div class="col-md-5 prof">
        ...
        <div class="col-md-8">
            ...
            <tr>
            <td><h3>MAKE ANNOUNCEMENTS</h3>
            <form action='../softeng/pages/storeAnnouncements.php?dept=<?php echo $_GET['dept']?>' name="announcementForm" onsubmit="return confirmPostAnnouncement()" method='post'>
            <fieldset class='col-md-12'>
            <input type='text' name='announcementName' id='announcemenN' placeholder='Announcement Name'>
            </fieldset>
            <fieldset class='col-md-12'>
            <input type='date' name='announcementDate' id='announcemenD' placeholder='Announcement Date'>
            </fieldset>
            <fieldset class='col-md-12'>
            <textarea name='announcementDescription' id='announcementDesc' placeholder='Announcement Description...'></textarea>
            </fieldset>
            <fieldset class='col-md-12'>
            <input type="submit" class="btn btn-info" value="Create Announcement" name="createAnnouncement">
        	</form>
            </div>
        </div>
