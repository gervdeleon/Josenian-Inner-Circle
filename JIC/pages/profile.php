        ...
        <div class="col-md-4 ">
            <div class="col-md-12">
                ...
                <div class="sidebar">
                    ...
                    echo "<a href='profile.php' class='active list-group-item'>";
                    echo "<i class='fa fa-user'></i> PROFILE";
                    echo "</a>";
                    echo "<a href='wall.php' class='list-group-item'>";
                    echo "<i class='fa fa-user'></i> WALL";
                    echo "</a>";
                    echo "<a href='innercircle.php' class='list-group-item'>";
                    echo "<i class='fa fa-circle-o'></i> INNER CIRCLE";
                    echo "</a>";
                    echo "<a href='messaging.php' class='list-group-item'>";
                    echo "<i class='fa fa-envelope'></i> MESSAGES <span class='badge'>".$inbox['inboxNo']."</span></a></li>";
                    echo "</a>";
                    echo "<a href='requests.php' class='list-group-item'>";
                    echo "<i class='fa fa-bell'></i> REQUESTS <span class='badge'>".$r1['countStat']."</span>";
                    echo "</a>";
                    echo "<a href='uploadfiles.php' class='list-group-item'>";
        ...
        <div class="col-md-8">
            <table class="table table-striped">
                <tr>
                    ...
                    if ($_SESSION['idnum']!=$_SESSION['idnum']){
                        $id=$_SESSION['idnum'];
                        $loggedin=$_SESSION['idnum'];
            // echo "<form action='../softeng/pages/addtoinnercircle.php?id=".$id."&loggedin=".$loggedin."' method='post'>";
                        echo "<a class='btn btn-primary' href='../softeng/pages/addtoinnercircle.php?id=".$id."&loggedin=".$loggedin."' role='button' name='add'>Add to Inner Circle</a>";
            // echo "</form>";
