            ...
            <div class="col-md-12">
                ...
                <div class="sidebar">
                    ...
                    <div class="list-group">
                        <a href="departments.php?dept=<?php echo $_GET['dept']?>" class="list-group-item active">
        ...
        <div class="col-md-8">
            <table class="table table-striped">
                <tr>
                    ...
                    <tr>
                        <td><h3>ASK QUESTIONS</h3>
                            <form name="questionForm" action="../softeng/pages/storeQuestions.php?dept=<?php echo $_GET['dept']?>" method="post" onsubmit="return confirmQuestion()">
                                <textarea name="question" required style="max-width:100%; max-height: 150px; margin-bottom: 10px;"></textarea>
                                <input type="submit" class="btn btn-info" value="Ask" name="ask">
                            </form>
                    ...
                    include_once "../softeng/pages/displayQuestions.php";
