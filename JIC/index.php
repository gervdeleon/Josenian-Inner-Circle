                ...
                <div class="row">
                    ...
                    <div class="collapse navbar-collapse" id="main-menu">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <?php echo "<a href='pages/profile.php?id=".$_SESSION['idnum']."'>PROFILE</a></li>"; ?>
...
<div class="col-md-4 text-center">
    <div class="circle">
        <img src="logos/USJR2.png" align="middle" style="width: 100%; height: auto;">
    </div>
</div>
<div class="col-md-4 product-item text-center">
    <div class="image-holder">
...
<div id="portfolio">
    <div class="container" id="Grid">
        ...
        <table align="center">
            <tr><td><a href="pages/departments.php?dept=CAS"><img src="dept/CAS.png" class="lightbox-button"></a>
            </td>
            <td><a href="pages/departments.php?dept=CICCT"><img src="dept/CICCT.png" class="lightbox-button"></a>
            </td>
            <td><a href="pages/departments.php?dept=COC"><img src="dept/Commerce.png" class="lightbox-button"></a></td></tr>
            <tr><td><img src="img/pp/new/white.png"></td>
                <td><img src="img/pp/new/white.png"></td>
                <td><img src="img/pp/new/white.png"></td></tr>
                <tr>
                    <td><a href="pages/departments.php?dept=COENGG"><img src="dept/Engineering.png" class="lightbox-button"></a></td>
                    <td><a href="pages/departments.php?dept=COE"><img src="dept/COE.png" class="lightbox-button"></a>
                    </td>
                    <td><a href="pages/departments.php?dept=LAW"><img src="dept/Law.png" class="lightbox-button"></a>
                    </td></tr>
                    <tr><td><img src="img/pp/new/white.png"></td>
                        <td><img src="img/pp/new/white.png"></td>
                        <td><img src="img/pp/new/white.png"></td></tr>
            ...
            <div class="container" id="promotion">
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-4" >
                        <div class="video-holder" style="background: #fcd743; padding-left: 20px;">
                            <h3>Vision</h3>
